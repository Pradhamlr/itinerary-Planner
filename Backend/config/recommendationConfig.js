const recommendationConfig = {
  ...
  expansionGeneralMinAttractionReviews: Number(process.env.EXPANSION_GENERAL_MIN_ATTRACTION_REVIEWS || 1000),
  ...
  beachesInterestScoreThreshold: Number(process.env.BEACHES_INTEREST_SCORE_THRESHOLD || 0.9),
  softInterestScoreThreshold: Number(process.env.SOFT_INTEREST_SCORE_THRESHOLD || 0.8),
  softBeachesInterestScoreThreshold: Number(process.env.SOFT_BEACHES_INTEREST_SCORE_THRESHOLD || 0.85),
  expansionStrictInterestScoreThreshold: Number(process.env.EXPANSION_STRICT_INTEREST_SCORE_THRESHOLD || 0.72),
  expansionBeachesInterestScoreThreshold: Number(process.env.EXPANSION_BEACHES_INTEREST_SCORE_THRESHOLD || 0.82),
  expansionSoftInterestScoreThreshold: Number(process.env.EXPANSION_SOFT_INTEREST_SCORE_THRESHOLD || 0.64),
  expansionSoftBeachesInterestScoreThreshold: Number(process.env.EXPANSION_SOFT_BEACHES_INTEREST_SCORE_THRESHOLD || 0.75),
  ...
  expansionShoppingInterestScoreThreshold: Number(process.env.EXPANSION_SHOPPING_INTEREST_SCORE_THRESHOLD || 0.58),
  expansionShoppingSemanticInterestScoreThreshold: Number(process.env.EXPANSION_SHOPPING_SEMANTIC_INTEREST_SCORE_THRESHOLD || 0.72),
